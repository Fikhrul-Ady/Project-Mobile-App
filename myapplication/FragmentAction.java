...
public class FragmentAction extends Fragment {
    ...
    public static FragmentAction newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.activity_fragment_action, container, false);
        ...
        frameLayout1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), film_fastx.class);
        ...
        frameLayout2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), film_the_marvels.class);
                startActivity(intent);
            }
        });
        ...
        frameLayout3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), film_blue_beetle.class);
                startActivity(intent);
            }
        });
        return rootView;
