...
public class FragmentComedy extends Fragment {
    ...
    public static FragmentComedy newInstance(String param1, String param2) {
        FragmentComedy fragment = new FragmentComedy();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        frameLayout1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), film_monday_first_scanning.class);
        ...
        frameLayout2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), film_the_family_plan.class);
                startActivity(intent);
            }
        });
        ...
        frameLayout3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), film_candy_cane_lane.class);
                startActivity(intent);
            }
        });
        return rootView;
